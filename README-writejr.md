...
Your source file will be in the `jsonresume` format.

You can use any plain-text editor to write the file. Using an editor that supports JSON can help you avoid syntax errors. Such editors exist as applications and also as web services.

Alternatively, you can write your source file by
